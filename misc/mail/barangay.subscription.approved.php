                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#111111;">
                                        ...
                                        <p
                                            ...
                                            We're pleased to inform you that your <?php echo strtolower($plan) ?> subscription plan has been
                                            successfully approved, to view your receipt, click the button below.</p>
                                        <div class="text-right"><a href="<?php echo $link ?>" id="resetPassword"
                                                target="_blank">VIEW RECEIPT</a></div>
                                        <p
