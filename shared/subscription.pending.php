    ...
    <div class="bg-white shadow-sm rounded"
        ...
        <p class="p-6 text-center">
            <img src="../assets/img/misc/RuralConnectAltLogo.png" alt="Rural Connect Logo"
                width="500">
        <h3 class="text-center" style="padding-top: 15px">Your subscription is under review and awaiting administrative approval.</h3>
        <h5 class="text-center" style="padding-bottom: 15px; color:#D3D3D3">You'll be notified upon confirmation.</h5>
        </p>
        <div>
            <a href="../logic/logout.php" class="btn btn-danger shadow-sm w-100">Logout</a>
        </div>
    </div>
</div>
