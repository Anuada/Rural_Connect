...
<div class="container">
    <div class="bg-white shadow-sm rounded"
        ...
        <h3 class="text-center" style="padding-top: 15px">
            ACCOUNT PENDING! <i class="fas fa-hourglass-half"></i>
        </h3>
        <h5 style="padding-bottom: 15px; color:#D3D3D3">Your account is currently pending approval, we appreciate your
            patience and will notify you as soon as it's approved
        </h5>
        </p>
