    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-md-6 request-card">
            ...
            <form action="../logic/request_med.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
    <label class="form-label"><i class="fas fa-cogs"></i> Request Category</label>
    <select class="form-control" name="request_Category" required>
        ...
        <option value="Other">Other</option>
                ...
                <div class="mb-3">
                    <label class="form-label"><i class="fas fa-sort-numeric-up"></i> Prescription</label>
                    <input type="file" class="form-control" name="prescription" placeholder="Enter Prescription" required>
                </div>
