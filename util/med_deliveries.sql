...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2025 at 05:36 AM
...
INSERT INTO `request_med` (`id`, `city_health_id`, `barangay_inc_id`, `med_avail_Id`, `request_quantity`, `request_category`, `request_DosageForm`, `request_DosageStrength`, `receipt_image`, `requestStatus`, `paymentStatus`) VALUES
(9, 'eb48b13c-9094-4de4-afc2-786b9dc93f96', '6c0b0a91-03a3-4614-a6a9-1a46133e8a60', 19, '100', '(GEN) Biogesic', 'Syrup', 'ml', '../assets/img/upload_receipt/aa9efe80-8cb9-4759-ac83-e65d26370148.png', 'Accepted', 'Pending'),
(10, 'eb48b13c-9094-4de4-afc2-786b9dc93f96', '6c0b0a91-03a3-4614-a6a9-1a46133e8a60', 21, '500', 'Biogesic', 'Syrup', '2500', '../assets/img/upload_receipt/2fcc3b2b-596f-401f-b587-667641ac975f.png', 'Accepted', 'Pending'),
(11, 'eb48b13c-9094-4de4-afc2-786b9dc93f96', '6c0b0a91-03a3-4614-a6a9-1a46133e8a60', 19, '1000', '(GEN) PARACITAMOL', 'Tablet', '2500', '../assets/img/upload_receipt/6b7c2853-9017-4891-90c4-54e13ae8480a.png', 'Accepted', 'Pending');
